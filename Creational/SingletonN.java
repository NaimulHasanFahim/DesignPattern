...
class ChocolateBoiler {
     ...
     * if(uniqueInstance==null){ System.out.println(msg +
     * " Sync method : Creating chocolateboiler for the first and last time");
     * uniqueInstance = new ChocolateBoiler(); } else { System.out.println(msg +
     * " Unique instance exists!!!"); } return uniqueInstance; }
     */

    /*
     * The upper commented part of the code is absolutely okay. But we won't use it
     * as synchronized method is not optimized. Instead of it, we will use
     * synchronized block as given below.
     */
    ...
    public void boil() {
        if (!isEmpty() && !isBoiled()) {
            ...
            if (isEmpty())
                System.out.println("Can't boil beacuse boiler is empty");
            else
                System.out.println(this + " >> can't boil because already boiled");
        }
    }
    ...
    public void drain() {
        if (!isEmpty() && isBoiled()) {
            ...
            if (isEmpty())
                System.out.println("Can't drain beacuse boiler is empty");
            else
                System.out.println(this + " >> can't drain because not boiled yet");
        }
    }
